...
#### 2.3.1. 일반적인 플로우
  ...
  아래에서 제시하는 병합 플로우는 rebase와 merge를 동시에 하는 방법입니다. rebase 후에 fast-forward merge를 사용하여 깔끔한 브랜칭 전략을 채택하고 있습니다. 이 방법은 뒤에 나오는 [2.3.2. 릴리즈 플로우](#232-릴리즈-플로우)와 [2.3.3. 핫픽스 플로우](#233-핫픽스-플로우)에서도 동일하게 사용합니다.
