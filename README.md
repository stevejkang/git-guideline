...
### 1.2. 커밋 메세지
  ...
  > 상세한 커밋 메세지를 작성하도록 노력해야 합니다. 습관적으로 `-m` 옵션을 붙이는 single-line 커밋을 지향하도록 합니다. (`-m`이 multi-line 커밋을 작성할 수 없다는 의미는 아닙니다. 여기서는 좀 더 상세한 커밋 정보를 확인하기 위해 입력창으로 들어가 작성하자는 취지입니다.)
